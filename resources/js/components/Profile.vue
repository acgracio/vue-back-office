...
export default {
    ...
    methods: {
        getProfilePhoto() {
            //handle base64 problem
            //new value -> this.form.photo
            // get from db -> "img/profile/" + this.form.photo;
            let photo =
        ...
        updateInfo() {
            ...
            this.form
                ...
                .then(() => {
                    // handle success
                    Fire.$emit("AfterCreate"); //update info
        ...
        updateProfile(e) {
            ...
            if (file["size"] < 2111775) {
                reader.onloadend = file => {
                    ...
                    this.form.photo = reader.result; //assign the file to the photo
                };
